        ...
        <header class="flex flex-wrap sm:justify-start sm:flex-nowrap w-full bg-gray-800 text-sm py-4 dark:bg-white">
          <nav class="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between" aria-label="Global">
            <div class="flex items-center justify-between">
              <a class="flex-none text-xl font-semibold text-white dark:text-neutral-800" href="{{ route('books') }}">Books Blog</a>
              <div class="sm:hidden">
            ...
            <div id="navbar-dark" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:block">
              <div class="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
                ...
                <a class="font-bold text-white dark:text-black dark:hover:text-neutral-400"  href="{{ route('books') }}" aria-current="page">All Books</a>
