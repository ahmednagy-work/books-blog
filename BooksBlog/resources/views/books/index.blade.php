...
<img class="w-full" src="{{asset('cover.png')}}" alt="Sunset in the mountains">
    <div class="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
        ...
        <div class="border-b mb-5 flex justify-between text-sm">
            <div class="text-indigo-600 flex items-center pb-2 pr-2 border-b-2 border-indigo-600 uppercase">
                ...
                <a href="#" class="font-semibold inline-block">Books BLog</a>
            </div>
            <a href="#">See All</a>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
            ...
            <div class="rounded overflow-hidden shadow-lg flex flex-col">
                <a href="{{route('book-card',$book->id)}}" class="btn" role="button"></a>
                <div class="relative"><a href="{{route('book-card',$book->id)}}" class="btn" role="button">
                        <img class="w-full" src="{{asset('storage/'.$book->avatar_path)}}" alt="Sunset in the mountains">
                        <div
                ...
                <div class="px-6 py-4 mb-auto">
                    <a href="#"
                        class="font-medium text-lg inline-block hover:text-indigo-600 transition duration-500 ease-in-out inline-block mb-2">{{$book->title}}
                        </a>
                ...
                <div class="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
                    <span href="#" class="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
                        ...
                        <span class="ml-1">{{$book->publish_year}}</span>
                    </span>
    ...
    {{-- @foreach ($products as $product)
        <div class="card">
            ...
            <a href="{{ route('products.edit', ['id' => $product->id]) }}" class="btn" role="button">Edit</a>
            <a href="" class="btn2" role="button">Delete</a>
